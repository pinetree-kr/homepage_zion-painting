...
import { ActivityLog, BugReport } from '../../types';
import { 
  Activity, 
  AlertCircle, 
  CheckCircle, 
...
const mockBugReports: BugReport[] = [
  ...
  },
  {
    id: '3',
    title: '검색 기능 개선 요청',
    description: '키워드 검색 시 정확도 개선 필요',
    status: 'open',
    priority: 'medium',
    reportedBy: '박민수',
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-gray-900 mb-2">로그 관리</h1>
          <p className="text-muted-foreground">
            시스템 활동 로그와 버그 리포트를 관리합니다
          </p>
        </div>
        <Button 
        ...
        <TabsContent value="bugs" className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <Card>
              ...
              <CardContent>
                <div className="text-2xl">{bugReports.length}</div>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="pb-3">
                <CardTitle className="text-sm">접수</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader className="pb-3">
                <CardTitle className="text-sm">처리중</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader className="pb-3">
                <CardTitle className="text-sm">해결</CardTitle>
              </CardHeader>
              <CardContent>
