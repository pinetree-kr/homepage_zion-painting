  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-gray-900">회사 정보 관리</h2>
          <p className="text-muted-foreground text-sm">회사소개, 연혁, 조직도, 오시는길을 관리합니다</p>
        </div>
      ...
      <Tabs defaultValue="about" className="w-full">
        ...
        <TabsContent value="about" className="space-y-4">
          <Card className="p-6">
            <h3 className="text-gray-900 mb-4">회사소개 내용</h3>
            <EditorComponent 
        ...
        <TabsContent value="history" className="space-y-4">
          <Card className="p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-gray-900">연혁 관리</h3>
            ...
            <div className="space-y-4">
              {history.map((item) => (
                <div key={item.id} className="flex gap-4 items-start p-4 border border-border rounded-lg bg-white">
        ...
        <TabsContent value="organization" className="space-y-4">
          <Card className="p-6">
            <h3 className="text-gray-900 mb-4">조직도</h3>
            <EditorComponent 
        ...
        <TabsContent value="location" className="space-y-4">
          <Card className="p-6">
            <h3 className="text-gray-900 mb-4">오시는길</h3>
            <div className="space-y-4">
              <div>
                <Label>주소</Label>
                <Input
