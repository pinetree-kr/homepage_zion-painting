/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: b6475b747d6b711fe21c6ce6f69ac539)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		NCLOUD_CLIENT_ID: string;
		NCLOUD_CLIENT_SECRET: string;
		ASSETS: Fetcher;
	}
}
