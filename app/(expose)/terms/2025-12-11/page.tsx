      ...
      <div className="max-w-4xl mx-auto">
        <div className={cn("bg-white", wrapped ? "shadow-sm rounded-lg p-8" : "")}>
          <div className="mb-8">
            ...
            <p className="text-gray-600">시온 도장설비 서비스 이용약관</p>
          ...
          <div className="prose prose-sm max-w-none">
            ...
            <section className="mb-8">
              ...
              <ol className="list-decimal list-inside text-gray-700 leading-relaxed space-y-2">
                <li>"서비스"란 회사가 제공하는 도장설비 관련 정보, 상담, 견적 등의 서비스를 의미합니다.</li>
            ...
            <section className="mb-8">
              ...
              <ol className="list-decimal list-inside text-gray-700 leading-relaxed space-y-2">
                ...
                <li>회원은 개정된 약관에 동의하지 않을 경우 회원 탈퇴를 요청할 수 있으며, 개정된 약관의 효력 발생일 이후에도 서비스를 계속 이용할 경우 약관의 변경사항에 동의한 것으로 간주됩니다.</li>
              </ol>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">제5조 (서비스의 제공 및 변경)</h2>
              <ol className="list-decimal list-inside text-gray-700 leading-relaxed space-y-2">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">제6조 (서비스의 중단)</h2>
              <ol className="list-decimal list-inside text-gray-700 leading-relaxed space-y-2">
