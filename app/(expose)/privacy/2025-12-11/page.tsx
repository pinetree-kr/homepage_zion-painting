    ...
    return (
        <div className={cn("min-h-screen py-12 px-4 sm:px-6 lg:px-8", wrapped ? "bg-gray-50" : "bg-white")}>
            <div className="max-w-4xl mx-auto">
                <div className={cn("bg-white", wrapped ? "shadow-sm rounded-lg p-8" : "")}>
                    <div className="mb-8">
                        <h1 className="text-3xl font-bold text-gray-900 mb-2">개인정보 수집 및 이용 동의</h1>
                        <p className="text-gray-600">시온 도장설비 개인정보처리방침</p>
                        <p className="text-sm text-gray-500 mt-2">최종 수정일: 2025년 12월 11일</p>
                    </div>
                    ...
                    <div className="prose prose-sm max-w-none">
                        <section className="mb-8">
                            ...
                            <ol className="list-decimal list-inside text-gray-700 leading-relaxed space-y-2">
                                ...
                                <li>
                                    ...
                                    <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
                                        <li>도장설비 관련 정보 제공, 상담 및 견적 서비스 제공</li>
                        ...
                        <section className="mb-8">
                            ...
                            <ol className="list-decimal list-inside text-gray-700 leading-relaxed space-y-2">
                                ...
                                <li>각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.
                                    <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
                                        <li>
                                            <strong>회원 가입 및 관리:</strong> 회원 탈퇴 시까지 (단, 관계 법령 위반에 따른 수사·조사 등이 진행중인 경우에는 해당 수사·조사 종료 시까지)
                                        </li>
                                        <li>
                                            <strong>전자상거래에서의 계약·청약철회 등에 관한 기록:</strong> 5년
                                        </li>
                                        <li>
                        ...
                        <section className="mb-8">
                            ...
                            <ol className="list-decimal list-inside text-gray-700 leading-relaxed space-y-2">
                                ...
                                <li>회사는 원칙적으로 정보주체의 개인정보를 제3자에게 제공하지 않습니다. 다만, 다음의 경우는 예외로 합니다.
                                    <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
                            ...
                            <ol className="list-decimal list-inside text-gray-700 leading-relaxed space-y-2">
                                ...
                                <li>개인정보 파기의 절차 및 방법은 다음과 같습니다.
                                    <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
                                        ...
                                        <li>
                                            <strong>파기방법:</strong> 회사는 전자적 파일 형태로 기록·저장된 개인정보는 기록을 재생할 수 없도록 파기하며, 종이 문서에 기록·저장된 개인정보는 분쇄기로 분쇄하거나 소각하여 파기합니다.
                                        </li>
                                    </ul>
                                </li>
                            </ol>
                        ...
                        <section className="mb-8">
                            ...
                            <div className="bg-gray-50 p-4 rounded-lg">
                                ...
                                <p className="text-gray-700 mb-1">성명: 시온 도장설비</p>
                                <p className="text-gray-700 mb-1">직책: 관리자</p>
                                <p className="text-gray-700 mb-1">연락처: (이메일 주소 또는 전화번호)</p>
                            </div>
                        </section>

                        <section className="mb-8">
                            <h2 className="text-xl font-semibold text-gray-900 mb-4">제9조 (개인정보의 안전성 확보조치)</h2>
                            <p className="text-gray-700 leading-relaxed mb-4">회사는 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.</p>
                            <ol className="list-decimal list-inside text-gray-700 leading-relaxed space-y-2">
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-gray-700 leading-relaxed mb-4">
                                이 개인정보처리방침은 2025년 12월 11일부터 적용되며, 법령 및 방침에 따른 변경내용의 추가, 삭제 및 정정이 있는 경우에는 변경사항의 시행 7일 전부터 공지사항을 통하여 고지할 것입니다.
                            </p>
                        </section>
                    </div>
