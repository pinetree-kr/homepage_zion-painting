...
interface ManagementCustomerMembersPageProps {
...
export default async function ManagementCustomerMembersPage({ searchParams }: ManagementCustomerMembersPageProps) {
