  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-gray-900 text-2xl font-semibold">사업소개 관리</h2>
          <p className="text-gray-500 text-sm mt-1">사업분야와 사업실적을 관리합니다</p>
        </div>
      ...
      <Tabs defaultValue="areas" className="w-full">
        ...
        <TabsContent value="areas" className="space-y-4 mt-6">
          <Card className="p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-gray-900 text-lg font-semibold">사업분야 관리</h3>
            ...
            <div className="space-y-4">
              {businessAreas.map((area) => (
                <div key={area.id} className="p-4 border border-gray-200 rounded-lg bg-white space-y-4">
        ...
        <TabsContent value="achievements" className="space-y-4 mt-6">
          <Card className="p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-gray-900 text-lg font-semibold">사업실적 관리</h3>
