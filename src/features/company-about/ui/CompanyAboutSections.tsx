...
export default function CompanyAboutSections({
  ...
  return (
    <div className="pb-24">
      {/* 회사개요 섹션 */}
      {(introduction || greetings || vision || mission || strengths.length > 0 || values.length > 0) && (
        <section id="overview" className="scroll-mt-24 min-h-[300px] py-12">
          <Container>
      ...
      {/* 연혁 섹션 */}
      {histories.length > 0 && (
        <section id="history" className="bg-gray-50 min-h-[300px] py-12 scroll-mt-24">
          <Container>
      ...
      {sortedMembers.length > 0 && (
        <section id="organization" className="scroll-mt-24 min-h-[300px] py-12">
          <Container>
      ...
      {/* 오시는 길 섹션 */}
      {contactInfo && (
        <section id="location" className="bg-gray-50 min-h-[300px] py-12 scroll-mt-24">
          <Container>
